...
Then("the user should receive an error message {string}", async function (string) {
...
When("the user resets the form after submitting following inputs", async function (dataTable) {
    await powerTradePage.fillingForm(dataTable);
  }
);
